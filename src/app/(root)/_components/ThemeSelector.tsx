...
function ThemeSelector() {
  ...
  return (
    ...
    >
      ...
      <span className="hidden sm:inline text-gray-300 min-w-15 sm:min-w-17.5 text-left text-[10px] sm:text-xs group-hover:text-white transition-colors">
        {currentTheme?.label}
      </span>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 min-w-40 bg-[#1e1e2e]/95 
