...
type LanguageConfig = Record<
  string,
  {
    ...
    label: string;
    logoPath: string;
    pistonRuntime: { language: string; version: string }; // Retained for compatibility if needed, but will prioritize judge0Id
    judge0Id: number;
...
// Helper function to define code editor themes in Monaco
