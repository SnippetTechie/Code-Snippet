...
function Footer() {
  return (
    <footer className="relative bg-[#0a0a0f] border-t border-gray-800/50 mt-auto">
      <div className="absolute inset-x-0 -top-px h-px bg-linear-to-r from-transparent via-gray-700 to-transparent" />
